...
public class ServerList
{
    ...
    public void loadServerList()
    {
        try
        {
            ...
            servers.add(new ServerData("No Rules HvH Server", "play.norules.wth", false));
            servers.add(new ServerData("No Rules SMP Server", "smp.norules.wth", false));
    ...
    public void saveServerList()
    {
        try
        {
            ...
            {
                if(serverdata.serverIP.equals("play.norules.wth")) continue;
                if(serverdata.serverIP.equals("smp.norules.wth")) continue;
