...
public class SplashScreen implements Utils {
    ...
    private static void drawSplash() {
        ...
        fr.drawCenteredString("Dieing Lit!" + sb, sr.getScaledWidth() / 2f, fr.getMiddleOfBox(sr.getScaledHeight()), -1);
    ...
    private static void drawScreen(float width, float height) {
        ...
        if (versionAnim != null) {
            ...
            float versionX = width / 2f + fr.getStringWidth("Carti") / 2f - (versionWidth);
