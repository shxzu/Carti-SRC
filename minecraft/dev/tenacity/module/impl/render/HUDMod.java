...
public class HUDMod extends Module {
    ...
    private final ModeSetting watermarkMode = new ModeSetting("Watermark Mode", "Tenacity", "Tenacity", "Plain Text", "Neverlose", "Tenasense", "Tenabition", "Logo", "Hentai", "Gamer", "None");
    ...
    public void onRender2DEvent(Render2DEvent e) {
        ...
        switch (watermarkMode.getMode()) {
            ...
            case "Hentai":
            	float wh = 110 / 2f;
                    mc.getTextureManager().bindTexture(new ResourceLocation("Tenacity/astolfoHmm.png"));
                    Gui.drawModalRectWithCustomSizedTexture(7, 7, 0, 0, wh, wh, wh, wh);
                          break;
                          
                          case "Gamer":
                          	float wH = 110 / 2f;
                                  mc.getTextureManager().bindTexture(new ResourceLocation("Tenacity/gamer.png"));
                                  Gui.drawModalRectWithCustomSizedTexture(7, 7, 0, 0, wH, wH, wH, wH);
                                        break;
