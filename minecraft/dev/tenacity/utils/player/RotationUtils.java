...
public class RotationUtils implements Utils {
     ...
     public static float serverRotation = Rotation(30f, 30f);
	public static var limitAngleChange;
    ...
    private static float Rotation(float f, float g) {
    	return MathHelper.wrapAngleTo180_float(mc.thePlayer.prevRotationYawHead) - 90F;
	}
    ...
    public static float[] getRotationsNeeded(final Entity entity) {
        ...
        final double ySize = entity.posY + entity.getEyeHeight() / 3 - (mc.thePlayer.posY + mc.thePlayer.getEyeHeight());
